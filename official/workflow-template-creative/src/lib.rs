...
const PACKAGE_NAME: &str = "workflow-template-creative";
const CAPABILITY_NAME: &str = "workflow.template.creative";
const TEMPLATE_ID: &str = "creative-v1";
    ...
    WorkflowTemplate {
        ...
        phases: vec![
            ...
            phase(
                ...
                "storyboard",
                &["storyboard"],
                &["storyboard_requested", "visualizing"],
                &["storyboard_ready"],
                &["direct"],
            ),
            phase(
                ...
                "director",
                &["director"],
                &["direction_in_progress", "assets_aligned"],
                &["direction_ready"],
                &["assemble"],
            ),
            phase(
...
pub fn init(_input: String) -> FnResult<String> {
    log_info("workflow-template-creative initialized");
